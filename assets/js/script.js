...
var auditTask = function(taskEl) {
  ...
  // apply new class if task is near or overdue date
...
$(".list-group").on("change", "input[type='text']", function() {
  ...
  // replace current input with span
  $(this).replaceWith(taskSpan);

  // pass task's <li> element to auditTask function
...
$(".card .list-group").sortable({
  ...
  update: function(event) {
    ...
    // loop over current set of children in the list
    ...
    // update tasks object with new array
